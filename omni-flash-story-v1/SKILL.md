...
| `references/google-policy-omni-flash.md` | **Before every storyboard + video prompt** |
...
Read `google-policy-omni-flash.md`, `two-act-by-engine.md`, and engine card. Template: `act-storyboard.md`.
...
Read `google-policy-omni-flash.md` first. Every prompt must use **warm, family-friendly emotional drama** (PG-13), and end with the policy **Required line**.

Each prompt: `Vertical 9:16, 24fps, 10 seconds, warm natural lighting` + two-reference upload + timestamps + hard cuts.
...
**Storyboard + video**
- [ ] Policy file applied; Required line on every video prompt
- [ ] Warm PG-13 tone — no violence, weapons, slurs
