...
Read: two-act-by-engine.md, story-engines.md (per item engine), character-anchor-sheet.md, act-storyboard.md.
...
Read frames-to-video.md. Fill omniPrompts[] with EXACTLY 2 prompts per item.
